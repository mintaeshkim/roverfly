...
class ActionFilterButter(ActionFilter):
    ...
    def __init__(
        self, lowcut=None, highcut=4, sampling_rate=None, order=ACTION_FILTER_ORDER, num_joints=None
    ):
        ...
        self.highcut = (
            [float(x) for x in highcut] if highcut is not None else [ACTION_FILTER_HIGH_CUT]
        )
