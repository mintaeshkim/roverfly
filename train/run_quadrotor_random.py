...
def main():
    ...
    horizon_length = 64 if num_envs >= 16 else 16384  # 100hz: 64 if num_envs >= 16 else 16384
    n_steps = horizon_length
    batch_size = 32 * num_envs if num_envs >= 16 else 8192  # 100hz: 32 * num_envs if num_envs >= 16 else 8192
